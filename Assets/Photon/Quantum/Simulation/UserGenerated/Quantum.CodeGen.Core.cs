...
namespace Quantum {
  ...
  public unsafe partial struct Input {
    ...
    [FieldOffset(1)]
    public Byte EncodedMoveDirection;
    [FieldOffset(0)]
    public Byte ActionMask;
    public override readonly Int32 GetHashCode() {
      unchecked { 
        var hash = 19249;
        hash = hash * 31 + EncodedMoveDirection.GetHashCode();
        hash = hash * 31 + ActionMask.GetHashCode();
        return hash;
      }
    }
    ...
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        var p = (Input*)ptr;
        serializer.Stream.Serialize(&p->ActionMask);
        serializer.Stream.Serialize(&p->EncodedMoveDirection);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct FrameSyncKernelState : Quantum.IComponentSingleton {
    public const Int32 SIZE = 112;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public Int32 Tick;
    [FieldOffset(48)]
    public FPVector2 P0Position;
    [FieldOffset(80)]
    public FPVector2 P1Position;
    [FieldOffset(64)]
    public FPVector2 P0Velocity;
    [FieldOffset(96)]
    public FPVector2 P1Velocity;
    [FieldOffset(32)]
    public FP P0Energy;
    [FieldOffset(40)]
    public FP P1Energy;
    [FieldOffset(16)]
    public FP Accumulator;
    [FieldOffset(24)]
    public FP LastDistance;
    [FieldOffset(4)]
    ...
    public override readonly Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + P0Position.GetHashCode();
        hash = hash * 31 + P1Position.GetHashCode();
        hash = hash * 31 + P0Velocity.GetHashCode();
        hash = hash * 31 + P1Velocity.GetHashCode();
        hash = hash * 31 + P0Energy.GetHashCode();
        hash = hash * 31 + P1Energy.GetHashCode();
        hash = hash * 31 + Accumulator.GetHashCode();
        hash = hash * 31 + LastDistance.GetHashCode();
        hash = hash * 31 + BounceCount.GetHashCode();
        hash = hash * 31 + ActionCount.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (FrameSyncKernelState*)ptr;
        serializer.Stream.Serialize(&p->ActionCount);
        serializer.Stream.Serialize(&p->BounceCount);
        serializer.Stream.Serialize(&p->Tick);
        FP.Serialize(&p->Accumulator, serializer);
        FP.Serialize(&p->LastDistance, serializer);
        FP.Serialize(&p->P0Energy, serializer);
        FP.Serialize(&p->P1Energy, serializer);
        FPVector2.Serialize(&p->P0Position, serializer);
        FPVector2.Serialize(&p->P0Velocity, serializer);
        FPVector2.Serialize(&p->P1Position, serializer);
        FPVector2.Serialize(&p->P1Velocity, serializer);
    }
  }
  ...
  public unsafe partial class Frame {
    ...
    partial void InitGen() {
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.FrameSyncKernelState>();
      BuildSignalsArrayOnComponentRemoved<Quantum.FrameSyncKernelState>();
    ...
    partial void SetPlayerInputCodeGen(PlayerRef player, Input input) {
      ...
      i->EncodedMoveDirection = input.EncodedMoveDirection;
      i->ActionMask = input.ActionMask;
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.FrameSyncKernelState), Quantum.FrameSyncKernelState.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 1)
        ...
        .Add<Quantum.FrameSyncKernelState>(Quantum.FrameSyncKernelState.Serialize, null, null, ComponentFlags.Singleton)
        .Finish();
    }
    [Preserve()]
